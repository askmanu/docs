...
From finding code snippets, to understanding a new library, to getting started on a new codebase, manu answers from the most general to the most specific questions.

![](./images/home.png)

## Long story

askmanu appeared from the struggles that we as developers encountered every day.
...
askmanu can also contribute documentation to your repo.

It's a challenge to keep every project's documentation updated so we built the [askmanu Github app](https://github.com/apps/askmanu).

<img src="./images/askmanu-app.png" alt="askmanu github app" />

After installing the app, askmanu parses the entire codebase (it don't save any code) and creates an index of files that need documentation.

We then create one pull request at a time with new documentation.

You can see an example for our reference documentation [here](https://github.com/nanbingxyz/5ire/pull/342).
