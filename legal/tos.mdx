...
ask manu, shortly name manu is a software product developed and maintained by Onel Andrei George PFA ("we", "us", or "our"). By accessing or using askmanu ("Software"), you ("User" or "you") agree to be bound by these Terms of Service ("Agreement"). If you do not agree to the terms within this Agreement, please do not use or access the Software.

## 1. Use of Software

askmanu is provided to you under a limited, non-exclusive, non-transferable, and revocable license for personal, commercial, or educational use, subject to the terms of this Agreement.
...
All rights, title, and interest in and to the Software (excluding content provided by users) are and will remain the exclusive property of Onel Andrei George and its licensors.
...
Onel Andrei George PFA
[andrei@askmanu.co](mailto:andrei@askmanu.co)
